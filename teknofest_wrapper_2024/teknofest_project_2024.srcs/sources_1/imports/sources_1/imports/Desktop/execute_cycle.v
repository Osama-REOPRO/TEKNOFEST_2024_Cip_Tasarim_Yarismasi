module execute_cycle(clk, rst, RegWriteE, ALUSrcE, MemWriteE, ResultSrcE, BranchE, ALUControlE, 
    RD1_E, RD2_E, Imm_Ext_E, RD_E, PCE, PCPlus4E, PCSrcE, JtypeE, PCTargetE, RegWriteM, MemWriteM,
    ResultSrcM, RD_M, PCPlus4M, WriteDataM, ALU_ResultM, ResultW, ForwardA_E, ForwardB_E,
    funct3_E, WordSize_M);

    // Declaration I/Os
    input clk, JtypeE,rst, RegWriteE,ALUSrcE,MemWriteE,ResultSrcE,BranchE;
    ...
    reg RegWriteE_r, MemWriteE_r, ResultSrcE_r ,PCSrcE_r;
    reg [4:0] RD_E_r;
    reg [31:0] PCPlus4E_r, RD2_E_r, ResultE_r;
    reg [3:0] WordSize_E_r;
